...
public class ALMaxHeap {
    ...
    /*****************************************************
     * default constructor  ---  inits empty minheap
     *****************************************************/
    public ALMaxHeap() 
    { 
     ...
     * b) ASCII representation of the tree (slightly more complicated, much more fun)
     *****************************************************/
    ...
    /*****************************************************
      * Integer peekMax()
      * Returns max value of maxheap (root node's value)
	...
	//Add value as last node, to maintain completeness of tree
	_heap.add( addVal );
	...
	while( addValPos > 0 ) { //potentially swap until reach root
	    ...
	    //check if greater than parent. If so, swap up
	...
	while( pos < _heap.size() ) {
	    ...
	    //if greater than greatest child, then walked far enough
